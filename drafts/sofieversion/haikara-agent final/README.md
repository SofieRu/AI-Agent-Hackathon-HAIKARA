# Haikara - Multi-Agent Energy Optimization System

An AI-powered multi-agent system that optimizes data center workloads using the Beckn protocol to reduce energy costs and carbon emissions.
...
**DEG Hackathon 2024** | Beckn Protocol Implementation
